...
import { AdministrationGroupVmService } from './administration-group.vm.service';
...
@Component({
  ...
  styleUrls: ['./administration-group.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class AdministrationGroupComponent implements OnInit, AfterViewInit {
  ...
  constructor(public configService: ConfigService,
    public vm: AdministrationGroupVmService) { }
   ...
   */
  methodClickDetailGroup(group: AdmGroupRS): void {
  ...
  * @param group grupo seleccionado del listado
  */
  methodClickEditGroup(group: AdmGroupRS): void {
    this.selectedGroup = group;
 ...
 */
  accept() {
    this.selectedGroup ? this.groupEditPanel.onClose() : this.groupCreatePanel.onClose();
    this.selectedGroup = undefined;
