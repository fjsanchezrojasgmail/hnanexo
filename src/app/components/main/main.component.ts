...
import { DiagnosticRS } from '../../bean/rs/fhir/diagnosticRS.bean';
import { ProfileUserHnanexoStatus, AnswerWsAstare,
  PermissionsProfileUserHnanexo, AnswerIsPrescriberService, hnanexoConstants } from '../../bean/hnanexo-constants.bean';
import { HttpTokenizerService } from '../../service/http.tokenizer.services';
import { BundleUtil } from '../../util/bundle-utils';
import { DateUtil } from '../../util/date-util';
import { GenderUtil } from '../../util/gender-util';
import { SermasHNSessionUserDataRS } from '../../bean/rs/fhir/sermas-user.bean';
import { HNANEXOResourcesSharedFHIR, HnanexoServiceConstants } from '../../bean/hnanexo-service-constants';

import { IPropertiesServiceGeneric } from '../../service/build/service/iproperties-generic.service';
